...
![image-20210823112623109](markdown/Redis实战清单.assets/image-20210823112623109.png)
...
<img src="markdown/Redis实战清单.assets/image-20210823110331707.png" alt="image-20210823110331707" style="zoom:67%;" />
...
![image-20210823113053290](markdown/Redis实战清单.assets/image-20210823113053290.png)

### 3. 库存遗留问题

描述：Redis的`WATCH`命令底层是类似于CAS（check-and-set）的乐观锁实现机制。只要监视到数据被修改，就认为当前的操作是不安全的，于是放弃执行当前操作。

<img src="markdown/Redis实战清单.assets/image-20210823114852138.png" alt="image-20210823114852138" style="zoom:67%;" />
...
![image-20210823163000815](markdown/Redis实战清单.assets/image-20210823163000815.png)
